          ...
          {filteredGroups.length === 0 ? (
            ...
            filteredGroups.map((group) => (
              <div key={group.heading} style={{ marginBottom: '8px' }}>
                <div style={{ fontSize: '11px', fontWeight: 600, opacity: 0.5, padding: '4px 8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                  {group.heading}
                </div>
                {group.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {item.shortcut && (
                        <span style={{ fontSize: '11px', opacity: 0.6, padding: '2px 6px', borderRadius: '4px', backgroundColor: 'rgba(255, 255, 255, 0.08)' }}>
                          {item.shortcut}
                        </span>
                      )}
                    </div>
